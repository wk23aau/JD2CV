...
export const initializeAndResetUserCreditsIfNeeded = async (user) => {
  ...
  if (creditsAvailable === null || creditsAvailable === undefined || creditsLastResetDate !== todayDate) {
    ...
    console.log(`Initialized/Reset credits for user ID ${user.id} to ${creditsAvailable} for date ${creditsLastResetDate}`);
  }
