...
import { DEFAULT_CREDITS_REGISTERED } from '../src/constants';
    ...
    const updatedItems = items.map((item, i) => {
      if (i === index) {
        ...
        if ((field === 'isPresent' || field === 'isCurrent') && value === true) {
            // This logic is specific to WorkExperience and EducationEntry.
            // The if condition ensures we're dealing with one of those types.
            // Both types have an 'endDate' string property to clear.
            const updatableItem = newItem as unknown as WorkExperience | EducationEntry;
